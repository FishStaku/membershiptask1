  ...
  <div class="mm tilo">
    ...
    <div class="tab2">
    	...
    	<div class="tab2-item">
    		...
    		<div class="d-flex ia-center"><img src="<?php echo $this->get_asset('images', 'google-drive.svg') ?>" alt="logo" class="tab2-img"> <span class="ml25 title_whereStored"><?php _e("Google Drive", 'backup-backup'); ?></span></div>
    		<div class="ia-center">
